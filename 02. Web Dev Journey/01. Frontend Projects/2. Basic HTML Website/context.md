## 2. Basic HTML Website --> Beginner
Create simple HTML only website with multiple pages.

```
The goal of this project is to teach you how to structure a website using HTML i.e. different sections of a website like header, footer, navigation, main content, sidebars etc. Don't style the website, only focus on the structure. Styling will be done in separate projects.
```
...
![My Image](./Basic%20HTML%20Website.png)
